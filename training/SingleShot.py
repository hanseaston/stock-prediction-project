...
from data.polygon.constructor.versions.V1 import Constructor
...
def train_single_model(dataset_name, model_name, threshold):

    print(f'training {model_name} model...')

    dataset_constructor = Constructor(
        lag=LAG, threshold=threshold, date_start=None, date_end=None, dataset_name='sp500')
    train_X, train_y, valid_X, valid_y, test_X, test_y = dataset_constructor.build_dataset_all_tickers()
...
if __name__ == '__main__':
    ...
    if TRAIN_MODE:
        ...
        train_single_model(dataset_name, "neutral", 0)
