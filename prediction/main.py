...
def get_model_predictions(data, neutral_model, positive_model, negative_model, neutral_threshold, positive_threshold, negative_threshold):
...
def make_predictions_for_tomorrow():
    ...
    neutral_model_threshold = 0.8
    positive_model_threshold = 0.8
    negative_model_threshold = 0.8

    hybrid_predictions = get_model_predictions(
